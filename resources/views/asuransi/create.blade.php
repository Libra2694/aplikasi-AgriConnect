        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Ajukan Asuransi Pertanian</h5>
                    ...
                    <form action="{{ route('asuransi.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jenis_asuransi" id="jenis_asuransi" class="form-control"
                                value="{{ old('jenis_asuransi') }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="tanggal_daftar" id="tanggal_daftar" class="form-control"
                                value="{{ old('tanggal_daftar', now()->toDateString()) }}" required>
                        </div>
                        ...
                        {{-- Tombol Simpan --}}
                        <div class="text-end">
                            <button type="submit" class="btn btn-success">Ajukan Asuransi</button>
                        </div>
                    </form>
                </div>
            </div>
